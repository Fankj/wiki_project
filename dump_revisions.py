    ...
    for page in dump:
        ...
        if page.namespace == 3:
            ...
            for rev in page:
                ...
                record  = {"rev_timestamp": str(rev.timestamp),"rev_id": rev.id,"rev_user_text": rev.contributor.user_text,"rev_user_id": rev.contributor.id,"rev_page_title": page.title,"rev_page_id": page.id,"ns": page.namespace,"rev_diff": diff_content}
